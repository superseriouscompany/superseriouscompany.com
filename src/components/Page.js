...
<div>
  <section className="context">
    <p>
      Things we believe that are probably wrong.
    </p>
  </section>

  <section className="philosophy">
    <div className="quotes">
      <blockquote className="santi">
        ...
        <img src={require('../images/chatBubble.png')} className="chatBubble" alt="Chat bubble tail"/>
      </blockquote>

      <blockquote className="neil">
